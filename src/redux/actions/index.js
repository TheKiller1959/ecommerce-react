...
import { deleteProductFromCart, getFilterCategories, getFilterProducts, getProductById, getProducts, getProductsFromCart, searchCategories } from "../../services";
...
export const setSearchCategoriesThunk = (id) => {
